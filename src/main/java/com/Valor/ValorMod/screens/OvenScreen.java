package com.Valor.ValorMod.screens;
...
public class OvenScreen extends ContainerScreen<OvenContainer> {
    ...
    private final ResourceLocation GUI = new ResourceLocation(ValorMod.MOD_ID,"textures/gui/oven_gui.png");

    public OvenScreen(OvenContainer screenContainer, PlayerInventory inv, ITextComponent name) {
